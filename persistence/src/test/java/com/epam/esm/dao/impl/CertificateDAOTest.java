...
class CertificateDAOTest {
    ...
    private final static String CERTIFICATE_NAME = "Cars.by";
    private final static BigInteger TAG_ID = BigInteger.ONE;
    ...
    private Certificate certificate = new Certificate(CERTIFICATE_ID, CERTIFICATE_NAME, "Some description",
            BigDecimal.TEN, 10, LocalDateTime.now(), LocalDateTime.now());
