...
class CertificateConverterTest {
    ...
    public void convertToDtoTest(){
        Certificate certificate = new Certificate(ID, NAME, DESCRIPTION, PRICE, DURATION, CREATE_DATE, LAST_UPDATE_DATE);
    ...
    public void convertToEntityTest(){
        CertificateDTO certificateDTO = new CertificateDTO(ID, NAME, DESCRIPTION, PRICE, DURATION, CREATE_DATE, LAST_UPDATE_DATE);
