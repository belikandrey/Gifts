...
public class CertificateController {
    ...
    public ResponseEntity<?> findAll(@RequestParam(value = "tagName", required = false) String tagName,
        ...
        Collection<CertificateDTO> giftCertificates = ((CertificateService)certificateService).findAll(tagName, name, description, sortName, sortDate);
    ...
    public ResponseEntity<?> delete(@PathVariable("id") BigInteger id) {
        return certificateService.delete(id) ? new ResponseEntity<>(HttpStatus.NO_CONTENT) : new ResponseEntity<>(HttpStatus.NOT_FOUND);
    }
